...
## Level Zero Device 0
bash butil.sh -v levelzero stories15M.bin 2> $logFolder/log15_levelzero_0
bash butil.sh -v levelzero stories42M.bin 2> $logFolder/log42_levelzero_0
bash butil.sh -v levelzero stories110M.bin 2> $logFolder/log110_levelzero_0
...
## TornadoVM Device 0
bash butil.sh -v tornadovm stories15M.bin 2> $logFolder/log15_tornadovm_0
bash butil.sh -v tornadovm stories42M.bin 2> $logFolder/log42_tornadovm_0
bash butil.sh -v tornadovm stories110M.bin 2> $logFolder/log110_tornadovm_0
